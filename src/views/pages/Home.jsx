        ...
        <div className="wrapper">
          <div className="page-header">
            <div className="content-center">
              ...
              <p className="mb-4" style={{color: '#115740', fontSize: '18px', fontWeight: '500'}}>
                Founded by a unique blend of horsemen, owners, technologists, and entrepreneurs.
              </p>
              <Row className="row-grid justify-content-between align-items-center text-left">
                <Col lg="6" md="6" sm="6" xs="12">
                  <Button className="p-0"><img alt="..." src={require("assets/img/Enter_A_Horse.png")} /></Button>
                </Col>
                <Col lg="6" md="6" sm="6" xs="12">
                  <Button className="p-0"><img alt="..." src={require("assets/img/Register_Login.png")} /></Button>
                </Col>
              </Row>
            </div>
          </div>
